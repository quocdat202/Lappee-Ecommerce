          ...
          <div className="row">
            ...
            <div className="col-md-3 col-sm-6 ft-center">
              ...
              <ul className="support">
                <li>
                  <NavLink to="/chinhsachchung">Chính sách, quy định chung</NavLink>
                </li>
                <li>
                  <NavLink to="/chinhsachvanchuyen">Chính sách vận chuyển</NavLink>
                </li>
                <li>
                  <NavLink to="/chinhsachbaohanh">Chính sách bảo hành</NavLink>
                </li>
                <li>
                  <a href="#">Chính sách cho doanh nghiệp</a>
                </li>
                <li>
                  <NavLink to="/chinhsachhangchinhhang">Chính sách hàng chính hãng</NavLink>
                </li>
                <li>
                  <NavLink to="/baomatthongtin">Bảo mật thông tin khách hàng</NavLink>
                </li>
              </ul>
            </div>
            <div className="col-md-3 col-sm-6 ft-center">
