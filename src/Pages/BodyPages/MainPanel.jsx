...
const renderCenterImage = (image, index) => {
    if (image.position === 'center') return (
        <div className="center-image-item" key={index}>
            <img key={index} className="center-image-item-img" src={`${URL}/Images/Panels/${image.nameImage}`} alt={image.nameImage} />
        </div>
    )
}
const renderRightImage = (image, index) => {
    if (image.position === 'right') return (
        <div className="image-right-item" key={index}>
            <img key={index} className="image-right-img" src={`${URL}/Images/Panels/${image.nameImage}`} alt={image.nameImage} />
        </div>
    )
}
const renderBottom3Image = (image, index) => {
    if (image.position === 'bottom(3)') return (
        <div key={index} className="col-no-padding c-4">
            <img className="image-bottom-3-img" src={`${URL}/Images/Panels/${image.nameImage}`} alt={image.nameImage} />
        </div>
    )
}
const renderBottom4Image = (image, index) => {
    if (image.position === 'bottom(4)') return (
        <div key={index} className="col-no-padding c-3">
            <img className="image-bottom-4-img" src={`${URL}/Images/Panels/${image.nameImage}`} alt={image.nameImage} />
        </div>
    )
}
