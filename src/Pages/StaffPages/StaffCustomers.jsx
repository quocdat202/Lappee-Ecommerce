...
export default function StaffCustomers() {
    ...
    useEffect(() => {
        axios.get(`${URL}/data/user/mode=CUSTOMER`, null)
    ...
    const searchCustomerByName = () => {
        ...
        axios.get(`${URL}/data/user/customer/name=${name}`, null)
            .then(res => {
    ...
    const searchCustomerByID = () => {
        ...
        axios.get(`${URL}/data/user/customer/id=${idCustomer}`, null)
            .then(res => {
                setCustomers(res.data);
                alert("Lấy dữ liệu thành công");
            })
    ...
    const searchCustomerByEmail = () => {
        ...
        axios.get(`${URL}/data/user/customer/email=${email}`, null)
            .then(res => {
                setCustomers(res.data);
                alert("Lấy dữ liệu thành công");
            })
